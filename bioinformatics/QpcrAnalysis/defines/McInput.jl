...
const MC_FIELD_DEFS = [
    ...
    Field(:max_temperature,             Real,                  DEFAULT_MC_MAX_TEMPERATURE),
    ...
    Field(:norm_negderiv_quantile,      AbstractFloat,         DEFAULT_MC_NORM_NEGDERIV_QUANTILE),
    Field(:max_norm_negderiv,           AbstractFloat,         DEFAULT_MC_MAX_NORM_NEGDERIV),
    Field(:max_num_peaks,               Integer,               DEFAULT_MC_MAX_NUM_PEAKS),
