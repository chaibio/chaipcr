...
const MC_FIELD_DEFS = [
    ...
    Field(:denser_factor,               Int_T,               DEFAULT_MC_DENSER_FACTOR),
    ...
    Field(:max_num_cross_points,        Int_T,               DEFAULT_MC_MAX_NUM_CROSS_POINTS),
    ...
    Field(:max_num_peaks,               Int_T,               DEFAULT_MC_MAX_NUM_PEAKS, "top_N"),
