...
ft5x0x_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	err = gpio_request(GPIO_TO_PIN(1,17),FT5X0X_NAME);
	gpio_direction_input(GPIO_TO_PIN(1,17));
	gpio_export(GPIO_TO_PIN(1,17),true);
	ct_irq_num = gpio_to_irq(GPIO_TO_PIN(1,17));
