angular.module('dynexp.optical_test_single_channel')
  .service('OpticalTestSingleChannelHelper', [
    ...
    function Helper(CONSTANTS) {
      ...
      self.getResult = function(baseline, excitation) {
        return (excitation >= CONSTANTS.MIN_EXCITATION_FLUORESCENCE) &&
          (excitation / baseline >= CONSTANTS.MIN_EXCITATION_FLUORESCENCE_MULTIPLE) &&
          (excitation <= CONSTANTS.MAX_EXCITATION);
      };
