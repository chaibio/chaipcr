    ...
    function drawBox(line_config) {
      ...
      Globals.box.headerText = Globals.box.container.append('text')
        ...
        .text(function() {
          ...
          return wells[line_config.well] + ', Ch1';
        })
      ...
      Globals.box.TmText = Globals.box.container.append('text')
        .attr("font-size", headerTextSize + 'px')
        .attr('fill', "#000")
        .attr("font-weight", 700)
      ...
      var ctTextDims = Globals.box.TmText.node().getBBox();
      ...
      Globals.box.RFYTextLabel = Globals.box.container.append('text')
        ...
        .text(Globals.config.curve_type === 'normalized' ? 'RFU' : '-dF/dT');
    ...
    function setBoxRFYAndCycleTexts(x) {
      ...
      if (Globals.box && Globals.activePath) {
        ...
        if (Globals.box.TmText && Globals.activePathConfig.config.ct) {
          ...
          var cqText = 'Tm: ' + (cfg.ct[cfg.channel - 1] || '');
          Globals.box.TmText.text(cqText);
        }
      }
    }
