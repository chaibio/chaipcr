(function() {
  ...
  describe('Testing Scrollbar Directive', function() {
    ...
    it('should resize', function() {
      ...
      this.$rootScope.$broadcast('window:resize')
      expect(this.directive.parent().css('overflow')).toBe('hidden')
      expect(this.svg.attr('width')).toBe(this.directive.parent().width() + '')
      expect(this.background.attr('width')).toBe(this.directive.parent().width() + '')
      expect(this.handle.attr('width')).toBe(this.directive.parent().width() + '')
      this.$timeout.flush()
      expect(this.directive.parent().css('overflow')).toBe('')
